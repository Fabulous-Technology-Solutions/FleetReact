...
export default function InvoiceExpenses() {
  ...
  const header = ["Invoice ID", "Vendor Name", "Category", "Date Issued", "Amount", "Status", "Due Date", "Action",]
  const data = [
    {
      invoiceid: "INV-10023",
      ...
      <div className='border border-main rounded-[16px] bg-sidebar mt-4'>
        <div className='flex items-center justify-between p-4'>
          ...
          <div className='flex items-center justify-end gap-3'>
            ...
            <div>
              <button className='bg-navlink py-2 c-inverted border border-[#60A5FA] px-5 rounded-md'>Add Invoice </button>
            </div>
          </div>
        </div>
        <div>
