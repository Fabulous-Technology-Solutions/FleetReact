...
const InterviewDetails = ({ show, onHide }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-[#1F1F24] text-white rounded-lg shadow-lg p-6 w-full max-w-[520px] min-w-[320px]"
      ...
      >
        ...
        <Box className="grid grid-cols-2 gap-4 mt-6 max-h-[calc(100vh-300px)] overflow-y-auto">
          ...
          <div className="col-span-2">
            ...
            <div className="c-primary flex items-center gap-2 text-blue-400 text-sm font-medium cursor-pointer" onClick={() => setShowTranscript(!showTranscript)}>
              {showTranscript ? "Hide Transcription" : "View Transcription"} <FaLink />
            </div>
            ...
            {Array(5)
              ...
              .map((e, i) => (
                <div key={i}>
                  ...
                  <small>
                    Aenean quis lobortis ex, ac pulvinar sapien. Cras in neque
                    ac dolor auctor mattis. Mauris et est aliquam, suscipit
                    lacus quis, viverra sapien.
                  </small>
                </div>
              ))}
              </div>}
